...
const menuItems = [
    { name: 'Dashboard', route: 'admin.dashboard', icon: DashboardIcon, children: [], activePattern: 'admin.dashboard' },
    {
        ...
        children: [
            ...
            { name: 'Hero Banners', route: 'admin.hero-banners.index', icon: PhotoIcon, activePattern: 'admin.hero-banners.*' },
            { name: 'Sponsors', route: 'admin.sponsors.index', icon: PhotoIcon, activePattern: 'admin.sponsors.*' },
            { name: 'Award Seasons', route: 'admin.season-awards.index', icon: TrophyIcon, activePattern: 'admin.season-awards.*' },
    ...
    },
    {
        ...
        children: [
            ...
            { name: 'Vote Attempt Logs', route: 'admin.vote-attempt-logs.index', icon: DocumentTextIcon, activePattern: 'admin.vote-attempt-logs.*' },
            { name: 'Vote Archives', route: 'admin.vote-archives.index', icon: DocumentTextIcon, activePattern: 'admin.vote-archives.*' },
