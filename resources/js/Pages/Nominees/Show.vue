...
defineProps({
  ...
  security: {
    type: Object,
    default: () => ({ turnstile_enabled: false, turnstile_site_key: null }),
  },
  voteSession: {
    type: Object,
    default: null,
...
<template>
  <Head :title="nominee.name" />

  <div class="pt-32 pb-16 bg-black">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-6">
          <div>
            <h1 class="text-4xl font-bold text-white">{{ nominee.name }}</h1>
            <p class="text-yellow-400 mt-2">{{ category.name }}</p>
          </div>
