...
<template>
    ...
    <Head>
        ...
        <meta name="description"
            content="Pendekeza mtu, taasisi au kitengo kinachostahili kutambuliwa kupitia TAPHE Awards. Toa nafasi ya kutambua juhudi na mafanikio katika sekta mbalimbali za afya nchini Tanzania." />
        <!-- Open Graph / Facebook -->
        ...
        <meta name="twitter:title" :content="title + ' | TAPHE Awards'" />
