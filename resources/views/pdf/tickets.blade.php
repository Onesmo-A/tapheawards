...
<style>
    ...
    .ticket {
        ...
        /* 
        Boresho la Picha ya Mandhari: 
        Ondoa comment hapa chini na hakikisha una picha 'ticket-bg.jpg' kwenye public/images
        */
        {{-- 
        background-image: url("{{ $ticketBgBase64 }}");
...
@php
    ...
    // Picha ya mandhari (optional)
    // $ticketBgPath = public_path('images/ticket-bg.jpg');
    // if (file_exists($ticketBgPath)) {
    //     $ticketBgType = pathinfo($ticketBgPath, PATHINFO_EXTENSION);
    //     $ticketBgData = file_get_contents($ticketBgPath);
    //     $ticketBgBase64 = 'data:image/' . $ticketBgType . ';base64,' . base64_encode($ticketBgData);
    // }
